                ...
                <div class="mx-auto w-full max-w-screen-xl">
                    <div class="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
                        ...
                        <div>
                            ...
                            <ul class="text-gray-500 dark:text-gray-400 font-medium">
                                ...
                                <li class="mb-4">
                                    <a href="#" class="hover:underline">Pricing & plan</a>
                                </li>
                                <li class="mb-4">
                                    <a href="#" class="hover:underline">ChargeLog</a>
                                </li>
                                <li class="mb-4">
                                    <a href="#" class="hover:underline">Our Method</a>
                                </li>
                            </ul>
                        </div>
                        <div>
                            <h2 class="mb-6 text-sm font-bold text-blue-500 uppercase dark:text-white">Legal</h2>
                            <ul class="text-gray-500 dark:text-gray-400 font-medium">
                                <li class="mb-4">
                        ...
                        <div>
                            <h2 class="mb-6 text-sm font-semibold text-blue-500 uppercase dark:text-white">Download</h2>
                            <ul class="text-gray-500 dark:text-gray-400 font-medium">
                                <li class="mb-4">
                    ...
                    <div class="px-4 py-6 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
                        ...
                        <div class="flex mt-4 sm:justify-center md:mt-0 space-x-5 rtl:space-x-reverse">
                            <a href="#" class="text-blue-400 hover:text-blue-900 dark:hover:text-blue-300">
